...
class Login extends Template implements ActionListener, Runnable
{
	...
	Login()
	{
		...
		TopLabel.setText("Packer Unpacker : Login");  //changes
		...
		text1.setToolTipText("ENTER USERNAME"); //Displays tip about what to do in frontpannel
		...
		text2.setToolTipText("ENTER PASSWORD"); //Displays tip about what to do in frontpannel
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==SUBMIT)
		{
			...
			if(value1.equals("GayGanesh")&& value2.equals("GayGanesh")) //change password hear
			{
	...
	public void run()
	{
		for(;;)
		{
			if(text2.isFocusOwner())
			{
				...
				{
					text2.setToolTipText("Warning : CAPS LOCKS is on");
				}
				else
